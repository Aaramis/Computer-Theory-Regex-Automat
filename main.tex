...
(c | a)${^*}$ a (c | a)${^*}$ u (c | a)${^*}$  | (g | a)${^*}$ a (g | a)${^*}$ u (g | a)${^*}$  | \\
\tab (c | u)${^*}$ a (c | u)${^*}$ u (c | u)${^*}$  | (g | u)${^*}$ a (g | u)${^*}$ u (g | u)${^*}$  | \\
\tab (c | a)${^*}$ u (c | a)${^*}$ a (c | a)${^*}$  | (g | a)${^*}$ u (g | a)${^*}$ a (g | a)${^*}$  | \\
\tab (c | u)${^*}$ u (c | u)${^*}$ a (c | u)${^*}$  | (g | u)${^*}$ u (g | u)${^*}$ a (g | u)${^*}$  | \\
\tab (c | u)${^*}$ g (c | u)${^*}$ c (c | u)${^*}$  | (g | u)${^*}$ g (g | u)${^*}$ c (g | u)${^*}$  | \\
\tab (c | a)${^*}$ g (c | a)${^*}$ c (c | a)${^*}$  | (g | a)${^*}$ g (g | a)${^*}$ c (g | a)${^*}$  | \\
\tab (c | u)${^*}$ c (c | u)${^*}$ g (c | u)${^*}$  | (g | u)${^*}$ c (g | u)${^*}$ g (g | u)${^*}$  | \\
...
\node[main] (11) [right of=a7] {7}; 
\node (18) [right of=11] {}; 
\node (110) [above of=11] {}; 
\node[main] (12) [below right of=18] {8};
\node[main] (13) [above of=12] {9}; 
\node[main] (14) [below of=12] {10};
\node[main] (15) [above of=13] {11}; 
\node (19) [above right of=12] {}; 
\node[main] (16) [right of=19] {12};
\node (17) [right of=16] {};
...
\node[main] (21) [right of=b7] {13}; 
\node (28) [right of=21] {}; 
\node (210) [above of=21] {}; 
\node[main] (22) [below right of=28] {14};
\node[main] (23) [above of=22] {15}; 
\node[main] (24) [below of=22] {16};
\node[main] (25) [above of=23] {17}; 
\node (29) [above right of=22] {}; 
\node[main] (26) [right of=29] {18};
\node (27) [right of=26] {};
...
\node[main] (31) [right of=c7] {19}; 
\node (38) [right of=31] {}; 
\node (310) [above of=31] {}; 
\node[main] (32) [below right of=38] {20};
\node[main] (33) [above of=32] {21}; 
\node[main] (34) [below of=32] {22};
\node[main] (35) [above of=33] {23}; 
\node (39) [above right of=32] {}; 
\node[main] (36) [right of=39] {24};
\node (37) [right of=36] {};


\path [->]  (1) edge node[above] {u} (3);
\path [->]  (1) edge node[above] {a} (2);
\path [->]  (2) edge [loop above] node[right,sloped] {c,u} (2);
\path [->]  (3) edge [loop above] node[right,sloped] {c,u} (3);
\path [->]  (4) edge [loop above] node[right,sloped] {c,u} (3);
\path [->]  (5) edge [loop above] node[right,sloped] {c,u} (4);
\path [->]  (1) edge [loop above] node {c,u} (1);
\path [->]  (6) edge [loop above] node {c,u} (6);
\path [->]  (2) edge node[above] {u} (6);
\path [->]  (3) edge node[above] {a} (6);
\path [->]  (6) edge node {} (7);
\path [->] (1) edge [bend left=10] node[above] {g} (5);
\path [->] (1) edge [bend right=10] node[above] {c} (4);
\path [->] (4) edge [bend right=10] node[above] {g} (6);
\path [->] (5) edge [bend left=10] node[above] {c} (6);
...
\path [->]  (15) edge [loop above] node[right,sloped] {c,a} (14);
...
\path [->]  (21) edge node[above] {a} (22);
\path [->]  (22) edge [loop above] node[right,sloped] {g,a} (22);
\path [->]  (23) edge [loop above] node[right,sloped] {g,a} (23);
\path [->]  (24) edge [loop above] node[right,sloped] {g,a} (23);
\path [->]  (25) edge [loop above] node[right,sloped] {g,a} (24);
\path [->]  (21) edge [loop above] node {g,a} (21);
\path [->]  (26) edge [loop above] node {g,a} (26);
\path [->]  (22) edge node[above] {u} (26);
\path [->]  (23) edge node[above] {a} (26);
\path [->]  (26) edge node {} (27);
\path [->] (21) edge [bend left=10] node[above] {g} (25);
\path [->] (21) edge [bend right=10] node[above] {c} (24);
\path [->] (24) edge [bend right=10] node[above] {g} (26);
\path [->] (25) edge [bend left=10] node[above] {c} (26);

\path [->]  (31) edge node[above] {u} (33);
\path [->]  (31) edge node[above] {a} (32);
\path [->]  (32) edge [loop above] node[right,sloped] {g,u} (32);
\path [->]  (33) edge [loop above] node[right,sloped] {g,u} (33);
\path [->]  (34) edge [loop above] node[right,sloped] {g,u} (33);
\path [->]  (35) edge [loop above] node[right,sloped] {g,u} (34);
\path [->]  (31) edge [loop above] node {g,u} (31);
\path [->]  (36) edge [loop above] node {g,u} (36);
\path [->]  (32) edge node[above] {u} (36);
\path [->]  (33) edge node[above] {a} (36);
\path [->]  (36) edge node {} (37);
\path [->] (31) edge [bend left=10] node[above] {g} (35);
\path [->] (31) edge [bend right=10] node[above] {c} (34);
\path [->] (34) edge [bend right=10] node[above] {g} (36);
\path [->] (35) edge [bend left=10] node[above] {c} (36);
