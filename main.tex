...
(4) edge [loop above] node[right,sloped] {u,g} (4)
(15) edge node {} (0)
(1) edge node {} (11)
(2) edge node {} (12)
(3) edge node {} (13)
...
\path [->]  (5) edge [loop above] node {c,u} (4);
...
\path [->]  (25) edge [loop above] node {g,a} (24);
...
\path [->]  (35) edge [loop above] node {g,u} (34);
